...
var grammar = {
    ...
    {"name": "IncludeLine", "symbols": [(lexer.has("INCLUDE") ? {type: "INCLUDE"} : INCLUDE), "_", "IncludeRef"], "postprocess": d => ({ type:"include", ref:d[2] })},
    ...
    {"name": "BindObjLine", "symbols": [{"literal":"ref"}, "_", {"literal":":"}, "_", "key"], "postprocess": d => ["ref", d[4]]},
    ...
    {"name": "Ref", "symbols": ["key"], "postprocess": d => ({ ref: d[0] })},
